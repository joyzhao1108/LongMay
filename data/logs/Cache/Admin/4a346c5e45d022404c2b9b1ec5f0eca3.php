...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="alist">
	  <tr>
	    ...
	    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td align='center'><a href="<?php echo U('Admin/Records/send',array('price'=>$vo['price'],'uid'=>$vo['uid'],'iid'=>$vo['id']));?>">入金</a> <a href="<?php echo U('Admin/Records/del',array('price'=>$vo['price'],'uid'=>$vo['uid'],'iid'=>$vo['id']));?>">删除</a> </td>
