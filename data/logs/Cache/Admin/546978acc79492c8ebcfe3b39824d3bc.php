...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    ...
    <tr> 
      ...
      <td><input type="text" name="site_name" value="<?php echo C('site_name');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：动维网</span>
	  </td>
    </tr>
	 <tr> 
	 ...
	 <tr> 
      ...
      <td><input type="text" name="site_url" value="<?php echo C('site_url');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://www.powkey.com</span>
    </tr>  
	<tr> 
	...
	<tr> 
      ...
      <td><input type="text" name="ipc" value="<?php echo C('ipc');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：沪IPC备123456789号</span>
    </tr>
	<tr> 
	...
	<tr> 
      ...
      <td><input type="text" name="site_email" value="<?php echo C('site_email');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例如:1314778@qq.com</span>
    </tr>
	<tr> 
	...
	<tr> 
      ...
      <td><textarea	 type="text" name="copyright" class="ipt" style="width:450px;height:60px;margin:5px 0 5px 0;" /><?php echo C('copyright');?></textarea><span>&nbsp;&nbsp;例:动维网版权所有</span>
    </tr>
