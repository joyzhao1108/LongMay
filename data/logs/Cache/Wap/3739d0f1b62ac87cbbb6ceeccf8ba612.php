...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="<?php echo RES;?>/css/103/iscroll.css" rel="stylesheet" type="text/css" />
		<link rel="stylesheet" href="<?php echo RES;?>/css/flash/css/plugmenu.css">
        <style>


        </style>
        <script src="<?php echo RES;?>/css/103/iscroll.js" type="text/javascript"></script>
    ...
    <body id="cate3">
        ...
        <div id="todayList">
            <ul class="todayList">
                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="only3">
