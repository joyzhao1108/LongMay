...
<div class="content">
          ...
          <div class="cLineB">
              <h4 class="left">创建会员卡号　<span style="color:red">此会员卡号,会员领取一张，这里将会少一张,当全部被领取完了,请再次开卡</span></h4>
              <br />
          ...
          <div class="cLine">
			<div class="pageNavigator left">
				...
				<a href="<?php echo U('Member_card/create_add',array('token'=>$token));?>" title="创建会员卡号" class="add">创建会员卡号
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
                <?php if(is_array($data_vip)): $i = 0; $__LIST__ = $data_vip;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data_vip): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td> 
                      <?php if($data_vip['wecha_id'] != false): ?><a href="index.php?g=User&m=Member_card&a=getuserinfo&id=<?php echo ($data_vip["wecha_id"]); ?>">查看详情</a><?php endif; ?>
