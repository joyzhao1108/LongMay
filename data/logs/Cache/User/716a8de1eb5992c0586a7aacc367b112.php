              ...
              <TBODY>
                <TR></TR>
                  ...
                  <TD>优惠券 <?php echo ($list["id"]); ?></TD>
				   ...
				   <a href="
				   <?php if($list['status'] == 1): ?>javascript:drop_confirm('你确定要结束活动吗，结束后不可再开启本活动!', 'index.php?g=User&m=Coupon&a=setdes&id=<?php echo ($list["id"]); ?>');<?php else: ?>index.php?g=User&m=Coupon&a=setinc&id=<?php echo ($list["id"]); endif; ?>">
