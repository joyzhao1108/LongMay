...
td{text-align: -webkit-left;}
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr bgcolor="#F1F1F1">
			...
			<td>
				<div class="mr15 l"><input id="menu_key" class="txt" name="keyword" title="关联关键词" value="" type="text"></div>
				<div class="system l"></div>
			</td>
		</tr>
		<tr bgcolor="#F1F1F1">
			...
			<td>
				<div class="mr15 l"><input id="menu_key" class="txt" name="url" title="外链接url" value="" type="text"></div>
				<div class="system l"></div>
			</td>
		</tr>
		<tr>
