            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
                <tr>
                  ...
                  <td><input type="text" required="" name="wxid" value="" class="px" tabindex="1" size="25">　<span class="red">请认真填写，错了不能修改。</span>比如：gh_423dwjkeww3 <a href="http://jingyan.baidu.com/article/9c69d48f46186e13c9024e30.html" target="_blank"><img src="<?php echo RES;?>/images/help.png" class="vm helpimg" title="帮助"></a></td>
                </tr>
                <tr>
                  <th><span class="red">*</span>微信号：</th>
                  <td><input type="text" required="" name="weixin" value="" class="px" tabindex="1" size="25">　比如：liangmeizi8 </td>
                </tr>
                 ...
                 <tr style="display:none">
                  ...
                  <td><input type="text" name="token" value="<?php echo ($tokenvalue); ?>" class="px" tabindex="1" size="40">(填写你的公众号)例：liangmeizi8,请勿填写文,或者其它特殊字符，此处token和腾讯平台必须一致!</td>
                </tr>
               ...
               （此处关联公交等本地化查询）
                ...
                <tr>
                  ...
                  <td><input type="text" required="" name="qq" value="" class="px" tabindex="1" size="25">　比如：service@powkey.com</td>
                </tr>
                 <tr style="display:none">
