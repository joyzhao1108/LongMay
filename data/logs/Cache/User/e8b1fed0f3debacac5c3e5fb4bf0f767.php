							...
							<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
								<tbody> 
									...
									<tr> 
										...
										<td><input type="text" id="fieldname" name="fieldname" value="<?php echo ($set["fieldname"]); ?>" class="px require" style="width:400px;" /></td> 
									</tr> 
									<tr> 
									...
									<tr> 
										...
										<th>&nbsp;</th>
										<td>
											<button type="submit" name="button" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Selfform/inputs',array('token'=>$token,'id'=>$thisForm['id']));?>" class="btnGray vm">取消</a>
										</td> 
									</tr> 
								</tbody>
							</table> 
