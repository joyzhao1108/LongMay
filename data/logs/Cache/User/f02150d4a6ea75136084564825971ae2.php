	  ...
	  <form class="form" method="post" action="" target="_top" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				...
				<tr>
					<th>回复图片：</th>
					<td><input type="text" name="picurl" value="<?php echo ($home["picurl"]); ?>" class="px" style="width:550px;"><input type=button class="btnFile btnGreen" onclick="window.open('<?php echo U('Upload/index',array('token'=>$token,'n'=>picurl));?>')" value="点击上传图片"><br/> 填写图片外链地址，大小为720x400					</td>
				</tr>
                <tr>
						<th>微站背景图片：</th>
						<td><input type="text" name="homebgurl" value="<?php echo ($home["homebgurl"]); ?>" class="px h23 w550 fl" style="width:550px;"><input type=button class="btnFile btnGreen" onclick="window.open('<?php echo U('Upload/index',array('token'=>$token,'n'=>homebgurl));?>')" value="点击上传图片"></td>
					</tr>
				<th>&nbsp;</th>
					<td>
