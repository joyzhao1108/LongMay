...
<div class="cLineB">
 ...
 <div class="cLineB">
<div class="pageNavigator left"><strong>此相册地址：<a href="" class="green"><?php echo C('site_url');?></a></strong></div>
<div class="clr"></div>
</div>
...
<tr>
	...
	<td>
		...
		<input class="px" style="width:250px;" type="text" name="picurl" value=""  />
...
<tr>
	...
	<td><div class="cateimg"></div><input class="px"  style="width:250px;"   type="text"   name="picurl" value="<?php echo ($photo["picurl"]); ?>"  /></td>
	<td><input class="px" type="text"  style="width:250px;"  name="info" value="<?php echo ($photo["info"]); ?>"  /></td>
	<td>
		<input class="checkbox" type="checkbox" name="status" value="1"  <?php if($list['status'] == 1): ?>checked<?php endif; ?> >
