...
<!--							<li>
				...
				<style type="text/css">
				.plug-menu {width:36px;height:36px;border-radius:36px;-moz-box-shadow:0 0 0 4px #FFFFFF, 0 2px 5px 4px rgba(0, 0, 0, 0.25);-webkit-box-shadow:0 0 0 4px #FFFFFF, 0 2px 5px 4px rgba(0, 0, 0, 0.25);box-shadow:0 0 0 4px #FFFFFF, 0 2px 5px 4px rgba(0, 0, 0, 0.25);background-color: FF0000;position:relative}
				.plug-menu span {display: block;width:28px;height:28px;background: url(<?php echo RES;?>/images/photo/menuplus.png) no-repeat;background-size: 28px 28px;text-indent: -999px;position:absolute;top:4px;left:4px;overflow: hidden;}
				</style>
				<script src="<?php echo RES;?>/js/cart/jscolor.js" type="text/javascript"></script>
				<div class="content">
					<div class="cLineB">
						<h4>快捷菜单 <span class="FAQ">提供一键拨号，一键导航等快捷功能</span></h4>
                          <p><span class="bold">一键拨号填写范例：</span>http://site.tg.qq.com/forwardToPhonePage?siteId=1&phone=手机 请拷贝网址粘帖到输入框，修改电话号码。</p>
                <p><span class="bold">一键导航填写范例：</span><a href="http://j.map.baidu.com/cv7B6" target="_blank" class="red">http://j.map.baidu.com/cv7B6</a>，点及网址→点击地图右上角工具<img src="<?php echo RES;?>/images/photo/baiduditu01.jpg" border="0" align="absmiddle"/>→点击标记<img src="<?php echo RES;?>/images/photo/baiduditu02.jpg" border="0" align="absmiddle"/>→标记你的位置→写名称备注→点保存→点分享<img src="<?php echo RES;?>/images/photo/baiduditu03.jpg" border="0" align="absmiddle"/>得到导航网址，拷贝粘帖到输入框。</p>
					</div>
					<form method="post" action="" enctype="multipart/form-data">
						<input type="hidden" name="formhash" id="formhash" value="<?php echo substr(str_shuffle(session(token)), 8); ?>">
						<div class="msgWrap bgfc" style="padding: 5px 20px;">
							<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
								<tbody>
									<tr>
										<td width="60"><div class="plug-menu" id="menupluscolor" style="background-color:<?php echo ($homeInfo["menupluscolor"]); ?>"><span class="close"></span></div></td>
										<td width="140"><strong>请选择快捷菜单的颜色：</strong></td>
										<td width="95"><input type="text" name="menupluscolor" id="themeStyle" value="<?php echo ($homeInfo["menupluscolor"]); ?>" class="px color" style="width: 55px; background-image: none; background-color:<?php echo ($homeInfo["menupluscolor"]); ?>; color: rgb(255, 255, 255);" onblur="document.getElementById('menupluscolor').style.backgroundColor=document.getElementById('themeStyle').value;"></td>
									...
									<td width="60"> </td>
										...
										<td colspan="2"><textarea class="px" style="width:550px; height:35px" name="copyright"><?php echo ($homeInfo["copyright"]); ?></textarea><br>例如：© 2003-2018 专一网络版权所有 </td>
									</tr>
						...
						<div class="msgWrap form">
							<div class="bdrcontent">
								<div id="div_ptype">
									<table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
										<thead>
											<tr>
												...
												<p>比如你想跳转到专一网络，就填写<a class="red">http://www.zynet.cc</a></p>
												</span></span></th>
									...
									<tbody>
										<tr>
											<td><img src="<?php echo RES;?>/images/photo/menuplus1.png" align="absmiddle" style=" background-color:#CCC;width:32px;"></td>
											<td>电话</td>
											<td><input class="px" type="text" style="width:250px;" name="tel_url" value="<?php echo ($homeInfo["tel_url"]); ?>"></td>
											<td><input type="text" name="tel_sort" value="<?php echo ($homeInfo["tel_sort"]); ?>" class="px" style="width:50px;"></td>
										
                                            <td>
				  <input type="radio" class="radio" class="ipt" value="1" name="tel_display" id="status1" <?php if(($homeInfo["tel_display"] == 1) OR ($homeInfo['tel_display'] == '') ): ?>checked=""<?php endif; ?> >
							启用
							<input type="radio" class="radio" class="ipt"  value="0" name="tel_display" id="status2" <?php if(($homeInfo["tel_display"]) == "0"): ?>checked=""<?php endif; ?> >
							关闭
                  </td>
										</tr>
										<tr>
											<td><img src="<?php echo RES;?>/images/photo/menuplus2.png" align="absmiddle" style=" background-color:#CCC;width:32px;"></td>
											<td>会员资料</td>
											<td><input class="px" type="text" style="width:250px;" name="memberinfo_url" value="<?php echo ($homeInfo["memberinfo_url"]); ?>"></td>
											<td><input type="text" name="memberinfo_sort" value="<?php echo ($homeInfo["memberinfo_sort"]); ?>" class="px" style="width:50px;"></td>                                                                                        <td>
				  <input type="radio" class="radio" class="ipt" value="1" name="memberinfo_display" id="status1" <?php if(($homeInfo["memberinfo_display"] == 1) OR ($homeInfo['memberinfo_display'] == '') ): ?>checked=""<?php endif; ?> >
							启用
							<input type="radio" class="radio" class="ipt"  value="0" name="memberinfo_display" id="status2" <?php if(($homeInfo["memberinfo_display"]) == "0"): ?>checked=""<?php endif; ?> >
							关闭
                  </td>
										</tr>
										<tr>
											<td><img src="<?php echo RES;?>/images/photo/menuplus3.png" align="absmiddle" style=" background-color:#CCC;width:32px;"></td>
											<td>导航</td>
											<td><input class="px" type="text" style="width:250px;" name="guide_url" value="<?php echo ($homeInfo["guide_url"]); ?>"></td>
											<td><input type="text" name="guide_sort" value="<?php echo ($homeInfo["guide_sort"]); ?>" class="px" style="width:50px;"></td>

                                             <td>
				  <input type="radio" class="radio" class="ipt" value="1" name="guide_display" id="status1" <?php if(($homeInfo["guide_display"] == 1) OR ($homeInfo['guide_display'] == '') ): ?>checked=""<?php endif; ?> >
							启用
							<input type="radio" class="radio" class="ipt"  value="0" name="guide_display" id="status2" <?php if(($homeInfo["guide_display"]) == "0"): ?>checked=""<?php endif; ?> >
							关闭
                  </td>
										</tr>
										<tr>
											<td><img src="<?php echo RES;?>/images/photo/menuplus5.png" align="absmiddle" style=" background-color:#CCC;width:32px;"></td>
											<td>分享</td>
											<td><input class="px" type="text" style="width:250px;" name="share_url" value="<?php echo ($homeInfo["share_url"]); ?>"></td>
											<td><input type="text" name="share_sort" value="<?php echo ($homeInfo["share_sort"]); ?>" class="px" style="width:50px;"></td>
                                                   <td>
				  <input type="radio" class="radio" class="ipt" value="1" name="share_display" id="status1" <?php if(($homeInfo["share_display"] == 1) OR ($homeInfo['share_display'] == '') ): ?>checked=""<?php endif; ?> >
							启用
							<input type="radio" class="radio" class="ipt"  value="0" name="share_display" id="status2" <?php if(($homeInfo["share_display"]) == "0"): ?>checked=""<?php endif; ?> >
							关闭
                  </td>
										</tr>									
										<tr>
