							...
							<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
								<tbody> 
									...
									<tr> 
										...
										<td><input type="text" name="logourl" value="<?php echo ($set["logourl"]); ?>" class="px" style="width:400px;" /><input class="btnFile btnGreen" type=button onclick="window.open('<?php echo U('Upload/index',array('token'=>$token,'n'=>logourl));?>')" value="点击上传图片"></td> 
									</tr>
									<tr> 
									...
									<tr>
										<th valign="top"><span class="red"></span>图文详细页内容：</th>
									...
									<tr>       
										...
										<td>
											...
											<button type="submit" name="button" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Groupon/products',array('token'=>$token));?>" class="btnGray vm">取消</a>
										</td> 
									</tr> 
								</tbody> 
							</table>
