...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="userinfoArea">
              <tbody>
               <tr>
                  <th valign="top"><span class="red">*</span><label for="title">店内常用关键词:</label></th>
                  <td><input type="text"  name="keyword"  id="title" value="<?php echo ($taobao["keyword"]); ?>"   class="px" tabindex="1" size="80"><br />例如：衣服|靴子|袜子|内衣 <span class="red">（触发类型为包含匹配）</span></td>
                </tr>
                <tr>
                 ...
                 <tr>
                  ...
                  <td><input type="text"  name="picurl"  id="picurl" value="<?php echo ($taobao["picurl"]); ?>"   class="px" tabindex="1" size="80"><input class="btnFile btnGreen" type=button onclick="window.open('<?php echo U('Upload/index',array('token'=>$token,'n'=>picurl));?>')" value="点击上传图片"> 填写外链图片地址</td>
                </tr>
                <tr>
                ...
                <tr>
                  <th valign="top"></th>
                  <td>例如：天猫3G店铺地址通常为：<a href="http://beilimy.m.tmall.com/" target="_blank">http://beilimy.m.tmall.com/</a>　 淘宝的3G店铺地址为：<a href="http://shop100651174.m.taobao.com" target="_blank">http://shop100651174.m.taobao.com</a><br />    
                  	</td>
                </tr>
                <tr>
                  <th></th>
                  <td><button type="submit" name="appidsubmit" value="true" class="btnGreen vm" ><strong>保存</strong></button></td>
                </tr>
              </tbody>
            </table>
</form>
