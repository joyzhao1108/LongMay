...
<div class="msgWrap">
  <form class="form" method="post"   action="<?php echo U('Flash/insert');?>"  target="_top" enctype="multipart/form-data" >
...
<TR>
  <TH valign="top"><label for="keyword">幻灯片图片外链地址：</label></TH>
  <TD><input type="input" class="px" id="keyword" value="" name="img" style="width:380px" ><input class="btnFile btnGreen" type=button onclick="window.open('<?php echo U('Upload/index',array('token'=>$token,'n'=>img));?>')" value="点击上传图片"><br />
                  为了提搞速度，建议将图片上传QQ空间然后获取链接地址，微信限制3秒内无反应将终止；图片(宽720高400)  </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
