...
<script src="<?php echo RES;?>/js/cart/common.js" type="text/javascript"></script>
<link rel="stylesheet" href="./themes/Static/kindeditor/themes/default/default.css" />
<link rel="stylesheet" href="./themes/Static/kindeditor/plugins/code/prettify.css" />
<script src="./themes/Static/kindeditor/kindeditor.js" type="text/javascript"></script>
<script src="./themes/Static/kindeditor/lang/zh_CN.js" type="text/javascript"></script>
<script src="./themes/Static/kindeditor/plugins/code/prettify.js" type="text/javascript"></script>
			...
			<tbody>
				<tr>
					<td valign="top">会员卡使用说明：<br>
						<textarea class="px" id="info" name="cardinfo" style="width: 400px; height: 200px; display: none;"><?php echo ($exchange["cardinfo"]); ?></textarea>
					</td>
					<td valign="top">积分规则说明：<br>
						<textarea class="px" id="info2" name="cardinfo2" style="width: 400px; height: 200px; display: none;"><?php echo ($exchange["cardinfo2"]); ?></textarea>
					</td>
				</tr>
				<tr>
					<td colspan="2">
