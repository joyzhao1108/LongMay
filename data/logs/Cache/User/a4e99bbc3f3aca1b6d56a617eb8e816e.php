...
<div class="content">
  ...
  <div class="cLineB">
            本次活动奖品总数：<span class="redamount"><?php echo ($datacount); ?></span>个　　　中奖人数：<span class="redamount"><?php echo ($recordcount); ?> </span>个　　已领取奖品：<span class="redamount">0</span>个          </div>
          ...
          <input name="delall"  type="hidden" value="" />
           <input name="wxid"  type="hidden" value="" />
            ...
            <td><?php if($record['sendtime'] == 0): else: echo (date('Y-m-d H:i:s',$record["sendtime"])); endif; ?>
              ...
              <?php else: ?>
               <a href="index.php?g=User&m=Lottery&a=sendnull&id=<?php echo ($record["id"]); ?>">取消发奖</a><?php endif; ?>
