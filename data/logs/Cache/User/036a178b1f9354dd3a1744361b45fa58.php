...
<div class="cLineB">
  <h4>幻灯片管理 <span class="FAQ">3G网站头部幻灯片。</span></h4>
  
 </div>
         <div class="cLineC" style="line-height: 32px;">
 <a  target="ddd" href="<?php echo U('Flash/add');?>" class="btnGrayS vm bigbtn" >添加幻灯片</a>　 
</div>
...
<th>幻灯片图片外链地址(宽720高400) <a  target="999" class="tooltips" ><img src="<?php echo RES;?>/images/price_help.png" align="absmiddle" /><span>
<p>分类图片最佳尺寸：宽720高400</p>
<p>不支持上传图片，请把图片上传到腾讯微博，再这里填写图片的外链地址。</p>
<p>如果不填写分类图片地址系统将随机分配默认图片。</p>
</span></a></th>
                        <th>幻灯片外链地址 <span class="tooltips" ><img src="<?php echo RES;?>/images/price_help.png" align="absmiddle" /><span>
...
<td class="norightborder">
	<a target="ddd" href="<?php echo U('Wap/Index/flash',array('token'=>$_SESSION['token']));?>">查看</a>
	<a target="ddd" href="<?php echo U('Flash/edit',array('id'=>$vo['id']));?>">编辑</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Flash/del',array('id'=>$vo['id']));?>');">删除</a>
</td>
