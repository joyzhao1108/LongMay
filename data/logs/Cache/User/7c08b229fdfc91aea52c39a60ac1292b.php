...
<div class="content">
	 <div class="cLineB">
		<h4>商家设置 </h4><a href="index.php?ac=card-list&amp;id=9878" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
	 </div>  
			...
			<tbody>
				<tr>
					<td width="500px" rowspan="4" valign="top">商家简介：<br>
						<textarea class="px" id="info" name="info" style="width: 450px; height: 230px; "><?php echo ($info["info"]); ?></textarea>
					</td>
					<td valign="top">商家logo外链地址(图片尺寸100x100)<br>
						<input type="input" class="px" id="logo" name="logo" value="<?php echo ($info["logo"]); ?>" style="width:250px;" onblur="document.getElementById('cardlogo').src=document.getElementById('logo').value;">
					</td>
					<td rowspan="4" valign="top">&nbsp;</td>
					<td rowspan="4" valign="top"><img id="cardlogo" class="logo" src="<?php echo ($info["logo"]); ?>" width="100px" height="100px"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<input name="description" type="input"  class="px" id="logo2" style="width:250px;" onblur="document.getElementById('cardlogo').src=document.getElementById('logo').value;" value="<?php echo ($info["description"]); ?>"></td>
				</tr>
				<tr>
					<td valign="top">消费确认密码：<br>
					<input type="input" class="px" id="title" value="<?php echo ($info["password"]); ?>" name="password" style="width:150px;">
					<br>
	...
	<div class="cLineB">
		<h4>添加联系方式 <span class="FAQ">设置商家地址及联系电话。<a name="linkinfo"></a></span></h4>
	</div>
...
<div class="bdrcontent">
	...
	<table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
	 <form action="<?php echo U('Member_card/Contact');?>" method="post">  
		<thead>
			<tr>
				<th>区域名称</th>
				<th>详细地址</th>
		...
		<tbody>
			<tr>
				<td><input type="text" name="cname" value="" class="px" style="width:100px;"></td>
				<td><input type="text" name="info" value="" class="px" style="width:350px;"></td>
				<td><input type="text" name="tel" value="" class="px" style="width:150px;"></td>
				<td><input type="text" name="sort" value="" class="px" style="width:50px;"></td>
				<td class="norightborder"><button type="submit" class="btnGray vm"><strong>添加</strong></button></td>
			</tr>
		 </tbody>
		 	<tbody>
			<tr>
				<td rowssapn="5">
					<div class="cLineB">
						<h4>联系方式管理 <span class="FAQ">可编辑设置商家地址及联系电话。</span></h4>
					</div>				
				</td>
		...
		<?php if(is_array($contact)): $i = 0; $__LIST__ = $contact;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$contact): $mod = ($i % 2 );++$i;?><tbody>
				 <form action="<?php echo U('Member_card/contact_edit');?>" method="post">  
				<tr>
					<td><input type="text" name="cname" value="<?php echo ($contact["cname"]); ?>" class="px" style="width:100px;"></td>
					<td><input type="text" name="info" value="<?php echo ($contact["info"]); ?>" class="px" style="width:350px;"></td>
					<td><input type="text" name="tel" value="<?php echo ($contact["tel"]); ?>" class="px" style="width:150px;"></td>
					<td>
						<input type="text" name="sort" value="<?php echo ($contact["sort"]); ?>" class="px" style="width:50px;">
						<input type="hidden" name="id" value="<?php echo ($contact["id"]); ?>" class="px" style="width:50px;">
					</td>					
					<td class="norightborder"><button type="submit" class="btnGreen vm"><strong>修改</strong></button></td>
				</tr>
				</form>
