...
<div class="content">
          ...
          <form method="post" action="<?php echo U('User/Index/upsaveemail');?>" enctype="multipart/form-data">
            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
				...
				<tr>
                  ...
                  <td>
				  <input type="radio" class="radio" class="ipt" value="1" name="emailstatus" id="status1" <?php if(($info["emailstatus"] == 1) OR ($info['emailstatus'] == '') ): ?>checked=""<?php endif; ?> >
							启用
							<input type="radio" class="radio" class="ipt"  value="0" name="emailstatus" id="status2" <?php if(($info["emailstatus"]) == "0"): ?>checked=""<?php endif; ?> >
							关闭
                  </td>
                </tr>
