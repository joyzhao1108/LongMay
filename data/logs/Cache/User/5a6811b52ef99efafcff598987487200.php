...
<div id="wp" class="wp"><link href="./themes/User/default/common/css/style.css" rel="stylesheet" type="text/css">
        ...
        <div class="sideBar">
          <div class="catalogList">
            <ul>
				...
				<li class="selected"><a href="<?php echo U('Alipay/index');?>">会员充值</a></li>
				<li class="subCatalogList"><a href="<?php echo U('Index/pay');?>">会员续费</a></li>
            </ul>
          </div>
        </div>
