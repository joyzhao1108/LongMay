...
<input type="button" onclick="document.getElementById(&#39;cardlogo&#39;).src=document.getElementById(&#39;logo&#39;).value;" value="显示效果" class="btnGrayS"> 请填写你的logo外链地址或者 <input style="font-size:12px;color:red"type=button onclick="window.open('<?php echo U('Upload/index',array('token'=>$token,'n'=>logo));?>')" value="点击上传图片"></td>
</tr>
<tr>
<td colspan="2">会员卡的背景：
	...
	<option selected="">请选择会员卡背景图</option>
		<?php  for($i=1;$i<=23;$i++){ $i=$i<10?'0'.$i:$i; $str='./themes/User/default/common/images/card/card_bg'.$i.'.png'; if($card['bg']==$str){ echo $str='<option value="'.$str.'" selected="selected" >'.$i.'</option>'; }else{ echo $str='<option value="'.$str.'">'.$i.'</option>'; } } ?>
...
<td colspan="2">自己设计背景：
	...
	请填写你的背景图外链地址或者 <input style="font-size:12px;color:red"type=button onclick="window.open('<?php echo U('Upload/index',array('token'=>$token,'n'=>diybg));?>')" value="点击上传图片">
</td>
</tr>
<tr>
<td colspan="2">卡号文字颜色：
...
<tr>
	<td align="center">
		<textarea name="Lastmsg" class="px" id="news2" style="width:210px; height:36px" onblur="document.getElementById(&#39;news&#39;).src=document.getElementById(&#39;news2&#39;).value;"><?php echo ($card["Lastmsg"]); ?></textarea>
	</td>
	<td align="center">
		<textarea name="vip" class="px" id="vippower2" style="width:210px; height:36px" onblur="document.getElementById(&#39;vippower&#39;).src=document.getElementById(&#39;vippower2&#39;).value;"><?php echo ($card["vip"]); ?></textarea>
	</td>
	<td align="center">
		<textarea name="qiandao" class="px" id="qiandao2" style="width:210px; height:36px" onblur="document.getElementById(&#39;qiandao&#39;).src=document.getElementById(&#39;qiandao2&#39;).value;"><?php echo ($card["qiandao"]); ?></textarea>
	</td>
	<td align="center">
		<textarea name="shopping" class="px" id="shopping2" style="width:210px; height:36px" onblur="document.getElementById(&#39;shopping&#39;).src=document.getElementById(&#39;shopping2&#39;).value;"><?php echo ($card["shopping"]); ?></textarea>
	</td>
 </tr>
<tr>
<td></td>
...
<td align="center" valign="middle">
	...
	<a href="<?php echo RES;?>/images/card//template2.rar" class="green">请下载模板</a>
</td>
</tr>
<tr>
<td align="center">填写外链地址查看效果</td>
...
<tr>
<td align="center">
	<textarea name="memberinfo" class="px" id="user2" style="width:210px; height:36px" onblur="document.getElementById(&#39;user&#39;).src=document.getElementById(&#39;user2&#39;).value;"><?php echo ($card["memberinfo"]); ?></textarea>
</td>
<td align="center">
	<textarea name="membermsg" class="px" id="info2" style="width:210px; height:36px" onblur="document.getElementById(&#39;info&#39;).src=document.getElementById(&#39;info2&#39;).value;"><?php echo ($card["membermsg"]); ?></textarea>
</td>
<td align="center">
	<textarea name="contact" class="px" id="addr2" style="width:210px; height:36px" onblur="document.getElementById(&#39;addr&#39;).src=document.getElementById(&#39;addr2&#39;).value;"><?php echo ($card["contact"]); ?></textarea>
</td>
<td><button type="submit" name="button" class="btnGreen">保存</button></td>
</tr>
</tbody>
