...
<div class="content">
          ...
          <form method="post" action="<?php echo U('User/Index/upsavesms');?>" enctype="multipart/form-data">
            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
			    <tr>
                  ...
                  <td><input type="text" required="" class="px" name="phone" value="<?php echo ($info["phone"]); ?>" tabindex="1" size="25"><span class="red">用于接收订单的手机号</span>
                  </td>
                </tr>
                <tr>
                  <th><span class="red">*</span>短信平台账号：</th>
                  <td><input type="text" required="" class="px" name="smsuser" value="<?php echo ($info["smsuser"]); ?>" tabindex="1" size="25"><span class="red">支持平台：<a href="http://api.smsbao.com/" target="_blank">点击注册</a><a href="<?php echo C('site_url');?>/sms" target="_blank"><img src="<?php echo RES;?>/images/help.png" class="vm helpimg" title="帮助"></a></span>
                  </td>
                </tr>
				<tr>
                  <th><span class="red">*</span>短信平台密码：</th>
                  <td><input type="text" required="" class="px" name="smspassword" value="<?php echo ($info["smspassword"]); ?>" tabindex="1" size="25">
                  </td>
                </tr>
				<tr>
                  <th><span class="red">*</span>短信平台状态：</th>
                  <td>
				  <input type="radio" class="radio" class="ipt" value="1" name="smsstatus" id="status1" <?php if(($info["smsstatus"] == 1) OR ($info['smsstatus'] == '') ): ?>checked=""<?php endif; ?> >
							启用
							<input type="radio" class="radio" class="ipt"  value="0" name="smsstatus" id="status2" <?php if(($info["smsstatus"]) == "0"): ?>checked=""<?php endif; ?> >
							关闭
                  </td>
                </tr>
