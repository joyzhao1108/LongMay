...
<div class="content">
          <div class="cLineB"><h4>云相册</h4></div>
          <form method="post" action="<?php echo U('User/Index/upsaveyun');?>" enctype="multipart/form-data">
          <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
          <div class="msgWrap">
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
			    <tr>
                  <th><span class="red">*</span>云相册AppKey：</th>
                  <td><input type="text" required="" class="px" name="yunuser" value="<?php echo ($info["yunuser"]); ?>" tabindex="1" size="25">
                  <span class="red">如何获取云相册AppKey</span><a href="<?php echo C('site_url');?>/yunpic" target="_blank"><img src="<?php echo RES;?>/images/help.png" class="vm helpimg" title="帮助"></a>
                  </td>
                </tr>
                <tr>
                  <th><span class="red">*</span>云相册AppSecret：</th>
                  <td><input type="text" required="" class="px" name="yunpassword" value="<?php echo ($info["yunpassword"]); ?>" tabindex="1" size="25">
                  <span class="red">如何获取云相册AppSecret</span><a href="<?php echo C('site_url');?>/yunpic" target="_blank"><img src="<?php echo RES;?>/images/help.png" class="vm helpimg" title="帮助"></a>
                  </td>
                </tr>
				<tr>
                  <th><span class="red">*</span>云相册用户名：</th>
                  <td><input type="text" required="" class="px" name="yunname" value="<?php echo ($info["yunname"]); ?>" tabindex="1" size="25">
                  <span class="red">如何获取用户名</span><a href="<?php echo C('site_url');?>/getusername" target="_blank"><img src="<?php echo RES;?>/images/help.png" class="vm helpimg" title="帮助"></a>
                  </td>
                </tr>
				<tr>
                  <th><span class="red">*</span>云相册域名：</th>
                  <td><input type="text" required="" class="px" name="yundomain" value="<?php echo ($info["yundomain"]); ?>" tabindex="1" size="25">
                  <span class="red">如何获取域名</span><a href="<?php echo C('site_url');?>/geturl" target="_blank"><img src="<?php echo RES;?>/images/help.png" class="vm helpimg" title="帮助"></a>
                  </td>
                </tr>
				<tr>
                  <th><span class="red">*</span>云相册状态：</th>
                  <td>
				  <input type="radio" class="radio" class="ipt" value="1" name="yunstatus" id="status1" <?php if(($info["yunstatus"] == 1) OR ($info['yunstatus'] == '') ): ?>checked=""<?php endif; ?> >
							启用
							<input type="radio" class="radio" class="ipt"  value="0" name="yunstatus" id="status2" <?php if(($info["yunstatus"]) == "0"): ?>checked=""<?php endif; ?> >
							关闭
                  </td>
                </tr>
				<div style="display:none;">
				<input type="text" required="" class="px" name="wxname" value="<?php echo ($info["wxname"]); ?>" tabindex="1" size="25">
				<input type="text" disabled="disabled" required="" title="无法修改，您可以联系管理员" name="wxid" value="<?php echo ($info["wxid"]); ?>" class="px" tabindex="1" size="25" style="color:#DDD;">
				<input type="text" required="" name="weixin" value="<?php echo ($info["weixin"]); ?>" class="px" tabindex="1" size="25">
				...
				<input type="text" class="px" id="province" value="<?php echo ($info["province"]); ?>" name="province" tabindex="1" size="20">
				<input id="city" value="<?php echo ($info["city"]); ?>" type="text" name="city" class="px" tabindex="1" size="20">
				<input type="text" required="" class="px" tabindex="1" value="<?php echo ($info["qq"]); ?>" name="qq" size="25">
				<input type="text" required="" name="wxfans" value="<?php echo ($info["wxfans"]); ?>" class="px" tabindex="1" size="25">
				<input type="text" required="" name="type" value="<?php echo ($info["typeid"]); ?>" class="px" tabindex="1" size="25">
				</div>
              </thead>
