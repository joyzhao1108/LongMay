...
<script src="/themes/Static/artDialog/jquery.artDialog.js?skin=default"></script>
<script src="/themes/Static/artDialog/plugins/iframeTools.js"></script>
        <div class="content">
<div class="cLineB">
<h4 class="left">团购订单管理（<a href="<?php echo U('Product/orders',array('token'=>$token,'handled'=>0));?>">未处理订单<span style="color:#f00"><?php echo ($unhandledCount); ?></span>个</a>） (<?php echo ($page); ?>) </h4>
...
<div class="tab">
<ul>
<li class="current tabli" id="tab0"><a href="<?php echo U('Groupon/index',array('token'=>$token));?>">团购订单管理</a></li>
<li class="tabli" id="tab2"><a href="<?php echo U('Groupon/products',array('token'=>$token));?>">团购管理</a></li>
<li class="tabli" id="tab2"><a href="<?php echo U('Reply_info/set',array('token'=>$token,'infotype'=>'Groupon'));?>">团购回复配置</a></li>
</ul>
</div>
<!--tab end-->
<div class="msgWrap">
