     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       ...
       <tr> 
        ...
        <td><input type="text" name="ppicurl" value="<?php echo ($set["ppicurl"]); ?>" class="px" style="width:400px;" /><input class="btnFile btnGreen" type=button onclick="window.open('<?php echo U('Upload/index',array('token'=>$token,'n'=>ppicurl));?>')" value="点击上传图片"> 填写图片外链地址，推荐大小为720x400</td> 
       </tr> 
       <tr> 
        <th><span class="red">*</span>订单页头部图片：</th> 
        <td><input type="text" name="headpic" value="<?php if($set["headpic"] != false): echo ($set["headpic"]); else: echo RES;?>/images/cart_info/online.jpg<?php endif; ?>" class="px" style="width:400px;" /> 不会自定义请留空:填写图片外链地址，推荐大小为720x125，高度可根据自身需求调整。<br />不填默认本图片: <a target="ss" href="<?php echo C('site_url');?>/themes/User/default/common/images/cart_info/online.jpg">点击查看</a> </td> 
       </tr> 
           ...
           <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%"> 
            ...
            <tbody> 
             <tr> 
              ...
              <td width="200"><input type="text" name="picurl" value="<?php echo ($set["picurl"]); ?>" class="px" style="width:160px;" /></td> 
