...
<div class="qtcontent">
        <div class="intro">
            <div class="normalTitle"><h2>关于<?php echo C('site_name');?></h2></div>
            <div class="normalContent">
                <div class="section ">
                    <div>
                    	<img style="float:right;margin:0 0 15px 15px;" alt="<?php echo C('site_name');?>公众号" src="<?php echo RES;?>/images/ewm2.jpg">
                        <p>
...
<p>YiCms除了自定义库,也支持自定义关键词触发指定接口url处理业务(完美的兼容第三方微信接口和自己的业务接口)即可实现和你们自己的数据库的信息通信!  
                        </p>
                    </div>
                <p class="clr"></p>
            	</div>
