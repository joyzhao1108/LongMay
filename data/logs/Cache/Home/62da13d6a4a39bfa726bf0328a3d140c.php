...
<title>功能介绍－<?php echo C('site_name');?> 微信帮手 微信公众账号</title>
...
<div class="abody">
          <div>
                    	<img style="float:left;margin:0 0 15px 15px;" alt="<?php echo U('site_name');?>" src="themes/Home/new/common/images/ewm2.jpg">
                        <p>
