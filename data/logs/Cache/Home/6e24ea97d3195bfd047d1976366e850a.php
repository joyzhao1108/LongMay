...
<span class="y">
<a class="xi2" href="<?php echo U('Index/reg');?>">还没有帐号？现在注册</a>
</span>
<h3 class="xs2" id="layer_reginfo_t">
登录-<?php echo C('sitename');?></h3>
</div>
...
<td><input type="text" required="" maxlength="15" size="25" autocomplete="off" tabindex="1" class="px er" name="username" id="idname" onclick="if(this.value=='请输入用户名'){this.value=''}" onblur="if(this.value==''){this.value='请输入用户名'}" />
</td>
<td class="tipcol"></td>
</tr>
</tbody></table>
...
<td><input type="password" required="" class="px" tabindex="1" size="25" name="password" id="pwd"></td>
<td class="tipcol"></td>
</tr>
</tbody></table>
</div>
...
<em>&nbsp;</em>
<button tabindex="1" value="true" name="regsubmit" type="submit" id="registerformsubmit" class="btnGreen"><strong>登 录</strong></button>
<a href="<?php echo U('Index/regpwd');?>">忘记密码</a>　
</span>
</td>
<td></td>
</tr>
