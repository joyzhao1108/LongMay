...
<!--banner-->
<div id="banner">
	<div class="banner"><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin={arzn::C('site_qq')}&site=qq&menu=yes" rel="nofollow"><img src="<?php echo RES;?>/images/banner.png" width="1003" height="460" /></a></div>
</div>
<!--body-->
<!--功能 beign-->
...
<div id="profile">
	<img style="float:left;margin:0 0 15px 15px;" alt="YiCms" src="<?php echo RES;?>/images/ewm2.jpg">YiCms微信志在帮助那些不懂技术的个人或企业建立属于自己的接口程序，让完全不懂技术的个人或企业通过简单的配置，即可拥有强大的功能。企业使用YiCms微信可以用低廉的成本实现智能客服机器人功能，淘宝店家可以轻松实现店铺商品和粉丝的关联与互动，我们也即将为微信地方号运维人员提供强大的地方运维的管理功能模块（如商家管理,店铺管理,会员管理,活动管理,优惠券管理,以及基于LBS的各种服务的开发!）

YiCms微信不提供文章内容库，避免同质化的内容泛滥，同时YiCms微信对用户有门槛要求，必须拥有自己的域名空间。YiCms微信为个人或企业提供了强大的自定义回复及图文信息分类功能，通过此功能能更好做出属于自己或企业特色的内容，并自动建立一个个人或企业手机3G网站，更好的服务于您的客户。

YiCms微信还提供了一些便民查询和娱乐游戏功能供个人或企业使用，如：查天气，查快递，翻译，百科，人品计算，手机归属地查询，笑话，成语接龙，公交查询，谜语，百度问答，解梦，古诗欣赏等等，根据需求的不同选择某些功能，能更好的提高粉丝活跃度，忠诚度。
