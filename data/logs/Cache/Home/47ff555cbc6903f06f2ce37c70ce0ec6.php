...
<p>自定义分：自定义文本、自定义图文、自定义语音。限额数的意思是，你在本微信管理平台写一个图文就少一个自定义图文〔vip0图文、文本、语音都有2000自定义，够挥霍了。〕</p>
</span></span></td>
                				<td>80</td>
                				<td>300</td>
                				<td>700</td>
...
<p>用户购买VIP流量套餐后会赠送用户一些功能和请求数，这个请求数被称为赠送请求数。</p>
</span></span></td>
                				<td>1000</td>
                				<td>5000</td>
                				<td>10000</td>
...
<p>	V0 页面有:此页面是由【<a href="<?php echo C('site_url');?>"><?php echo C('site_name');?>接口平台</a>】系统生成 版权信息</p>
                			...
                			<tr >
               				  <td height="50" class="lefttitle"> <span class="red STYLE2"><a href="<?php echo C('site_url');?>/chongzhi"target="_blank">充值请先点击这里查看流程。</a></span></td>
...
<tr>
            ...
            <div class="section lastSection">
<p><a href="<?php echo C('site_url');?>" target="999" class="red">如何充值购买VIP，请点击查看。</a>有疑问的请QQ<?php echo C('site_qq');?>提问。</p>
       		  </div>
            </div>
        </div>
    </div>
...
帮助您快速搭建属于自己的营销平台,构建自己的客户群体。【微商城、微团购、微店铺、微订餐、微酒店】<br/>
大转盘、刮刮卡，会员卡,优惠卷,订餐,订房等营销模块,客户易用,易懂,易营销,易服务理念）。
</div>
<div id="copyright">
	<?php echo C('site_name');?>(c)2013-2018 版权所有<br/>
